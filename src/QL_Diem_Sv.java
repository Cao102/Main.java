...
class QL_Diem_Sv {
    static Connection conn = DatabaseConnect.getConnection();
    public QL_Diem_Sv(){

    }
    public static void themDiem(int student_id, int subject_id, double grade){
    ...
    public static void suaDiem(int student_id, int subject_id, double grade){
