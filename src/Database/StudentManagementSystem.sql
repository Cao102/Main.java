...
-- Library
INSERT INTO Library (book_id, book_name, author) VALUES
('B001', 'Data Structures', 'Mark Allen'),
('B002', 'Physics Principles', 'John Doe'),
('B003', 'English for Beginners', 'Anna Smith'),
('B004', 'Organic Chemistry Basics', 'Thomas Green');


-- BorrowedBooks
INSERT INTO BorrowedBooks (student_id, book_id, borrow_date, return_date) VALUES
('S001', 'B001', '2025-03-01', '2025-03-15'),
('S002', 'B002', '2025-03-05', '2025-03-20'),
('S003', 'B003', '2025-03-10', '2025-03-25'),
('S004', 'B004', '2025-03-12', '2025-03-27');
...
('English Speaking Contest', '2025-05-15 09:00:00', 'Conference Room A'),
('Chemistry Lab Tour', '2025-05-20 10:00:00', 'Lab 202');
